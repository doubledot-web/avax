...
?>
<section class="woocommerce-order-details uk-margin-medium-top">
	<?php do_action( 'woocommerce_order_details_before_order_table', $order ); ?>

	<h2 class="woocommerce-order-details__title uk-text-light"><?php esc_html_e( 'Order details', 'woocommerce' ); ?></h2>

	<table class="woocommerce-table woocommerce-table--order-details shop_table order_details uk-width-1-1 uk-table uk-table-middle">
