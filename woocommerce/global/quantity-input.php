...
<div class="quantity-wrapper uk-margin-bottom1">
	...
	<div class="quantity">
		...
		<input
			...
			class="<?php echo esc_attr( join( ' ', (array) $classes ) ); ?> uk-h5 uk-margin-remove"
	...
	<button type="button" class="plus btn-base uk-flex" aria-label="<?php esc_attr_e( 'Remove items', 'wpcanvas' ); ?>">
