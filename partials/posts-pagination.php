	...
	<section class="section section-posts-pagination uk-margin-large-top uk-text-center">
		<nav class="navigation pagination" aria-label="<?php esc_attr_e( 'Posts pagination', 'wpcanvas' ); ?>">
			...
			<div class="nav-links">
				...
				echo paginate_links(
					array(
						'prev_text' => '<span class="screen-reader-text">' . __( 'Newer Posts', 'wpcanvas' ) . '</span><svg width="13" height="22" aria-hidden="true"><use xlink:href="#chevron-prev-arrow"></use></svg>',
						'next_text' => '<span class="screen-reader-text">' . __( 'Older Posts', 'wpcanvas' ) . '</span><svg width="13" height="22" aria-hidden="true"><use xlink:href="#chevron-next-arrow"></use></svg></span>',
					)
				);
				?>
			</div>
