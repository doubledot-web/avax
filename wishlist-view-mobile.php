...
<!-- WISHLIST MOBILE -->
<ul
	class="shop_table cart wishlist_table wishlist_view responsive mobile uk-padding-remove <?php echo $show_cb ? 'with-checkbox' : ''; ?> <?php echo $no_interactions ? 'no-interactions' : ''; ?>"
					...
					<div class="item-wrapper">
						...
						<div class="item-details">
							<div class="product-name">
								<h3>
									<a class="text-black" href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item->get_product_id() ) ) ); ?>">
					...
					<div class="additional-info-wrapper">
						...
						<?php if ( $show_remove_product || $repeat_remove_button ) : ?>
							<div class="product-remove">
								 ...
								 */
								?>
								<a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>"><svg width="17" height="17" aria-hidden="true"><use xlink:href="#close"></use></svg></a>
							</div>
						<?php endif; ?>
					</div>
				</li>
