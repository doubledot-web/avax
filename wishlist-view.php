...
<!-- WISHLIST TABLE -->
<table
	class="shop_table cart wishlist_table wishlist_view traditional responsive uk-width-1-1 <?php echo $no_interactions ? 'no-interactions' : ''; ?> <?php echo $enable_drag_n_drop ? 'sortable' : ''; ?> "
	...
	<tr>
		...
		<th class="product-name">
			<span class="nobr">
				 ...
				 * @return string
				 */
				echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_name_heading', __( 'Description', 'yith-woocommerce-wishlist' ), $wishlist ) );
				?>
			</span>
		</th>
		...
		<?php if ( $show_remove_product ) : ?>
			...
			<th class="product-remove">
				<span class="nobr">
					 ...
					 * @return string
					 */
					echo esc_html( apply_filters( 'yith_wcwl_wishlist_view_remove_heading', __( 'Remove', 'wpcanvas' ), $wishlist ) );
					?>
				</span>
			</th>
		<?php endif; ?>
					...
					<?php if ( $show_remove_product ) : ?>
						<td class="product-remove uk-text-center">
							<div>
								 ...
								 */
								?>
								<a href="<?php echo esc_url( $item->get_remove_url() ); ?>" class="remove remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>"><svg width="17" height="17" aria-hidden="true"><use xlink:href="#close"></use></svg></a>
							</div>
						</td>
					<?php endif; ?>
